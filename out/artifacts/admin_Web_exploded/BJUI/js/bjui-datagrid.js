        ...
        var tools = {
            ...
            quickFilter: function(model, filterDatas) {
                    ...
                    case 'like':
                        if (model.type == 'select') {
                            ...
                            if (val2 != null &&
                                ...
                                typeof val1['id'] != 'undefined' &&
                                typeof val2['id'] != 'undefined') {
                                compare = (String(val2['id']).indexOf(String(val1['id'])) >= 0)
                            } else {
                ...
                var filterData = function(data, filterDatas) {
                    //data 是待过滤对象数组，filterDatas 是参照对象
        ...
        $tds.each(function(i) {
                        ...
                        for (var key in args) {
                            ...
                            if (op.name == key) {
                                if ($el.val() == args[key]) $td.removeClass(that.classnames.td_changed);
                                    ...
                                    var isObject = typeof args[key] == 'object';
                                    if (isObject && typeof args[key]['data_show'] != 'undefined' ) {
                                        $el.val(args[key]['data_show'])
                                    } else {
                                        $el.val(args[key])
                                    }
                                }
            ...
            if (input) {
                ...
                if (op.type == 'boolean') $input.prop('checked', val);
                    ...
                    if (!val || val == 'null') val = '';
                    if (typeof val == 'object' && typeof val['name'] != 'undefined') {
                        $input.val(String(val['name']))
                    } else {
    ...
    Datagrid.prototype.inlineEditComplete = function($tr, trData, $btn) {
        ...
        $.each(columnModel, function(i, n) {
            ...
            if (n.render && typeof n.render == 'function') {
                ...
                $td.text(render_label).removeClass(that.classnames.td_edit).removeClass(that.classnames.td_changed)
            } else {
