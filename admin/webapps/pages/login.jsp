...
<head>
    ...
    <title>数字出版管理系统登录</title>
    <script src="<lms:path/>/BJUI/js/jquery-1.7.2.min.js"></script>
    <script src="<lms:path/>/BJUI/js/jquery.cookie.js"></script>
    <script src="<lms:path/>/js/sha256.js"></script>
    <link href="<lms:path/>/BJUI/themes/css/bootstrap.min.css" rel="stylesheet">
    <style type="text/css">
        * {font-family: "Verdana", "Tahoma", "Lucida Grande", "Microsoft YaHei", "Hiragino Sans GB", sans-serif;}
        body {
            background: url(<lms:path/>/images/loginbg_01.jpg) no-repeat center center fixed;
...
<div class="main_box">
    ...
    <div class="login_box">
        ...
        <div class="login_form">
            ...
            <form action="<lms:path/>/login" id="login_form" method="post">
                ...
                <div class="form-group">
                    <label for="j_captcha" class="t">验证码：</label> <input id="j_captcha" name="authCode" type="text" class="form-control x164 in">
                    <img id="captcha_img" alt="点击更换" title="点击更换" src="<lms:path/>/images/captcha.jpeg" class="m">
                </div>
                <div class="form-group">
                    <label class="t"></label>
    ...
    <div class="bottom">Copyright &copy; 2014 - 2015 <a href="#">lms.cn</a></div>
</div>
</body>
</html>