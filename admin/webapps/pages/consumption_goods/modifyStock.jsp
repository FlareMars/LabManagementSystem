...
<div class="bjui-pageContent">
  <form action="<lms:path/>/consumption_goods/modifyStock" class="pageForm" data-toggle="validate" id="modifyStockRequest" data-callback="myCallback">
    <input type="hidden" name="id" value="${param.goodsId}">
