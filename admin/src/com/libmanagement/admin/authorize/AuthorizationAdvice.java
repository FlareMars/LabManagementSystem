package com.libmanagement.admin.authorize;

import com.libmanagement.common.web.authorize.Authorization;
import com.libmanagement.admin.common.RestBaseBean;
import com.libmanagement.admin.common.Result;
import com.libmanagement.admin.common.WebBaseBean;
...
public class AuthorizationAdvice {
    private static Log logger = LogFactory.getLog(AuthorizationAdvice.class);
